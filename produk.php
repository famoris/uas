...
<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(img/1.jpeg);">
				...
				<div class="item-slick1" style="padding-top: 70px; background-image: url(img/3.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url(img/2.webp);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									...
									<div class="row">
										...
										<div class="col-md-6">
			<!-- 								<a href="chat&p=<?= $ambilproduk1['idproduk'] ?>"> <button class="btn btn-warning ">
                                            <span class="fa fa-wechat "></span> Chat</button> </a>						
 -->
											<form method="POST" action="chat.php">
												<input type="hidden" name="idproduk" value="<?= $ambilproduk1['idproduk'] ?>">
												<button type="submit" name="lihat" class="btn btn-warning" style="width: 100px">
													 <span class="fa fa-wechat "></span> Chat
												</button>
											</form>
										</div>
										<div class="col-md-6">
<!--  											<td>
												<a href="detail_produk.php&idongkir=<?= $ambilproduk1['idproduk'] ?>" class="btn btn-success"><i class="fa fa-eyes"></i>Lihat Detail</a>
											</td>  -->
